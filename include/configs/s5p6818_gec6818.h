...
#define KERNEL_DTB_ADDR		0x49000000
 ...
 */
// #define CONFIG_S5P6818_SERIAL
#define CONFIG_S5P6818_SERIAL_INDEX		0
#define CONFIG_S5P6818_SERIAL_CLOCK		50000000
#define CONFIG_S5P6818_SERIAL_PORT		(void *)PHY_BASEADDR_UART0
...
#define CONFIG_UART_CLKGEN_CLOCK_HZ	CONFIG_S5P6818_SERIAL_CLOCK
